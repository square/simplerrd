...
cache_area = SimpleRRD::Area.new(:data => cache, :color => 'A6CEE3', :alpha => 'CC')
...
free_area = SimpleRRD::Area.new(:data => free, :color => 'B2DF8A', :alpha => 'CC')
...
graph.generate("verbose_lines.png")
