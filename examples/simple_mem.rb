...
# make a lot of sense.  that's not the point, though..
...
buffer_area = SimpleRRD::Area.new(:data => buffers, :color => 'CAB2D6')
...
cache_line = SimpleRRD::Line.new(:data => cache, :text => "Used cache", :width => 2, :color => '1F78B4')
cache_area = SimpleRRD::Area.new(:data => cache, :color => 'A6CEE3')
...
free_line = SimpleRRD::Line.new(:data => free, :text => "Free memory", :width => 2, :color => '33A02C')
free_area = SimpleRRD::Area.new(:data => free, :color => 'B2DF8A')
